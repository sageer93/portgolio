...
const ProductScreen = ({ product, attributes, relatedProduct }) => {
  ...
  const [productMore , setProductMore] = useState(1)
          ...
          <div className="px-0 py-10 lg:py-10">
            <div className="mx-auto px-3 lg:px-10 max-w-screen-2xl">
              ...
              {relatedProduct?.length >= 2 && (
                  ...
                  <div className="flex">
                    <div className="w-full">
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 xl:grid-cols-6 2xl:grid-cols-6 gap-2 md:gap-3 lg:gap-3">
                        {relatedProduct?.slice(0, productMore*12).map((product, i) => (
                          <ProductCard
                            key={i}
                            product={product}
                ...
                <button onClick={()=>setProductMore(productMore +1)}>Show More</button>
              </div>
                </div>
              )}
            </div>
