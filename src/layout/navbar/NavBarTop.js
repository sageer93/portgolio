      ...
      <div className="hidden lg:block bg-gray-100">
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-10">
          <div className="text-gray-700 py-2 font-sans text-xs font-medium border-b flex justify-between items-center">
            <span className="topBar flex items-center">
            ...
            <div className="lg:text-right flex items-center">
              <Link href="/about-us">
                <a className="topbarnavLink font-medium hover:text-emerald-600">
                  {" "}
                  {t("common:About Us")}
                </a>
              </Link>
              ...
              <button
                onClick={handleModal}
                className="topbarnavLink font-medium hover:text-emerald-600"
              >
                {t("common:My account")}
              </button>
              <span className="mx-2">|</span>
              ...
              {userInfo ? (
                <>
                  ...
                  <button
                    ...
                    className="topbarnavLink flex items-center font-medium hover:text-emerald-600"
                  >
                    <span className="mr-1">
                      <FiUser />
                    </span>
